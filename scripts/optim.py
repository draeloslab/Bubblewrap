...
def inner_evaluate(parameters, scrap=0):
    obs, beh = NumpyDataSource.get_from_saved_npz("jpca_reduced_sc.npz", time_offsets=(1,))
...
def make_ax_client(generation_strategy):
    ...
    ax_client.create_experiment(
        name="symmetric_noisy_jpca_defaults",
        parameters=[
            {
